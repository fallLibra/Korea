...
<script>
	...
	import areaChoose from '@/pages/school/components/areaChoose.vue';

	// import pagination from '../../../static/plugins/jquery.pagination.js';
	export default{
		name: 'School',
		...
		computed: {
			area () {
				return this.$store.state.selectedcountryData.area
			}
		},
		methods: {
			initCity () {
