			...
			<div class="result_right">
				...
				<div class="result_canvas" style="background:#fff">
					...
					<ul class="school_name side_school_name">
						<li class="clearfix" v-for="(n,index) in schoolCaseData" :key="n.name">   
							<p class="name_left"><span class="colors">{{index+1}}</span>{{n.name}}</p>   
					        <p class="name_right"><span>{{n.value}}</span>个录取</p>
					    </li>
					</ul>
...
@import url("../../../static/stylesheet/pages/broadside.css");
